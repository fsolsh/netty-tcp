...
public class DelimiterBasedClient {
    ...
    public static void main(String[] args) throws InterruptedException {
        new DelimiterBasedClient().connect("127.0.0.1", 8080);
    }
            ...
            bootstrap.group(group)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel ch) {
                            ...
                            // 对服务端返回的消息通过_$进行分隔，并且每次查找的最大为1024字节
...
class DelimiterBasedClientHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ctx.writeAndFlush("hello server,this is a message " + DEFAULT_DELIMITER + " from the client!");
    }
